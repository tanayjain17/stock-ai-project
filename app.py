...
def train_ai(df):
    ...
    model=Sequential([
        tf.keras.layers.LSTM(50,return_sequences=True,input_shape=(X.shape[1],4)),
...
# --------------------------
# 4. PRE-TRAINED MODEL LOADING (OPTIONAL: Replace IDs)
MODEL_ID = "YOUR_MODEL_FILE_ID"   # Upload trained model to Google Drive
